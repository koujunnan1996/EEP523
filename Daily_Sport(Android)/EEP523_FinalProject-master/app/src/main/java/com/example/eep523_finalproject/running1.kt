...
import kotlinx.android.synthetic.main.running1.*
 ...
 */
class running1 : AppCompatActivity() {

    private var Input_num1: EditText? = null
    private var Input_num2: EditText? = null
    private var mFusedLocationClient: FusedLocationProviderClient? =
        null // Provides access to the Fused Location Provider API.
    ...
    private var mLocationRequest: LocationRequest? =
        null //parameters for requests to the FusedLocationProviderApi.
    ...
    private var mRequestingLocationUpdates: Boolean? =
        null //Tracks the status of the location updates request
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.running1)
        ...
        val back = findViewById(R.id.Running1_back) as Button
        ...
        back.setOnClickListener {
           // val finished : Boolean = false
            ...
            if(finished=="true"){
                map.put("Running(treadmill)",true)
            }
            val intent = Intent(this, MainActivity::class.java)
            intent.putExtra("where", "Running(treadmill)");
            intent.putExtra("check", finished);
            ...
            showSnackbar(R.string.permission_rationale,
                android.R.string.ok, View.OnClickListener {
                    ...
                    ActivityCompat.requestPermissions(
                        this@running1, arrayOf(Manifest.permission.ACCESS_FINE_LOCATION),
