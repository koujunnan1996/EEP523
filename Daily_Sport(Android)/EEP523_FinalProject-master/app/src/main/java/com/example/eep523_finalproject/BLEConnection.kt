...
class BLEConnection : AppCompatActivity(), BLEControl.Callback {
    ...
    fun update() {
        ...
        runOnUiThread() {
            ble!!.send("alarm")
            val alertDialog4: AlertDialog = this?.let {
...
//                            })
                    ...
                    .setMessage("your device is not around")
                    .setTitle("WARNNING !!")
...
//                            })
                        ...
                        // Set other dialog properties
                        .setMessage("Today is a little cold, The temperature is below 29°C")
        ...
        if (rx.getStringValue(0) == "3"){
            var temp2 = 0
            temp2 = rx.getStringValue(1).toInt()
            runOnUiThread(){
...
//                            })
                        ...
                        // Set other dialog properties
                        .setMessage("Today is a little hot, The temperature is higher than 29°C")
                        .setTitle("Wether report")
                    // Create the AlertDialog
                    builder.create()
                }
                alertDialog?.show()
