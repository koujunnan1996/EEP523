...
def train_net(
  ...
  open("koujunnan.tflite", "wb").write(tflite_model)
  ...
  # Save the model to disk
  open("koujunnan_quantized.tflite", "wb").write(tflite_model)
  ...
  basic_model_size = os.path.getsize("koujunnan.tflite")
  print("Basic model is %d bytes" % basic_model_size)
  quantized_model_size = os.path.getsize("koujunnan_quantized.tflite")
